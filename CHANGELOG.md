...
## [0.2.0](https://github.com/scaleapi/scale-agentex/compare/v0.1.0...v0.2.0) (2026-09-26)
...
* **agentex:** filter GET /agents by agent card metadata ([#411](https://github.com/scaleapi/scale-agentex/issues/411)) ([b0e3443](https://github.com/scaleapi/scale-agentex/commit/b0e344321949c43003c5c8c8f44e82fbd93b79ef))
...
* **api:** add optional observability adapter ([#434](https://github.com/scaleapi/scale-agentex/issues/434)) ([595f276](https://github.com/scaleapi/scale-agentex/commit/595f276a14987c40a58100a6f5d3ed3e513d0760))
* **ci:** promote production through a reviewed pull request ([#450](https://github.com/scaleapi/scale-agentex/issues/450)) ([63d2342](https://github.com/scaleapi/scale-agentex/commit/63d2342e59ce29f7257026bd3f8f4d34bd6aca85))
...
* **worker:** add optional observability adapter ([#436](https://github.com/scaleapi/scale-agentex/issues/436)) ([b9639f5](https://github.com/scaleapi/scale-agentex/commit/b9639f56a820dacade25982d7b73a29a498dc7e3))
...
* **agentex-ui:** bump next 15.5.21 to 15.5.24 and sharp 0.35.3 to 0.35.4 ([#424](https://github.com/scaleapi/scale-agentex/issues/424)) ([14a9f21](https://github.com/scaleapi/scale-agentex/commit/14a9f21cdf42492dd9a2df22b83d35657e725d5d))
...
* **agentex:** bump cryptography 46.0.6 -&gt; 50.0.0 and anyio 4.11.0 -&gt; 4.14.2 ([#432](https://github.com/scaleapi/scale-agentex/issues/432)) ([624d311](https://github.com/scaleapi/scale-agentex/commit/624d31182479bde5a4e1be932eb302c694b41ebc))
...
* **ci:** scope the metadata waiver, and fail the job when a target is blocked ([#451](https://github.com/scaleapi/scale-agentex/issues/451)) ([30003f9](https://github.com/scaleapi/scale-agentex/commit/30003f91ca609c007f576e789e31e92ac199c10a))
* **ci:** the promote token needs checks: read to read a pull request's checks ([#454](https://github.com/scaleapi/scale-agentex/issues/454)) ([dd10399](https://github.com/scaleapi/scale-agentex/commit/dd10399cd9b0d4855c1efad788b391cd8ff735ef))
* **ci:** the promote token needs workflows: write ([#449](https://github.com/scaleapi/scale-agentex/issues/449)) ([e4fbd25](https://github.com/scaleapi/scale-agentex/commit/e4fbd25d4ab5f30b6719b4f4529c089138a3b0ec))
...
* **logging:** omit api and stream payloads ([#435](https://github.com/scaleapi/scale-agentex/issues/435)) ([59ceacf](https://github.com/scaleapi/scale-agentex/commit/59ceacf5aa9a202e44209a81a517d403975bcf97))
...
* **stlc:** re-anchor python's seal and refuse to build on an off-trunk anchor ([#452](https://github.com/scaleapi/scale-agentex/issues/452)) ([ed0191c](https://github.com/scaleapi/scale-agentex/commit/ed0191c9d9c578d1722805e1c3bc9576f29484ea))
* **stlc:** re-anchor typescript's seal before it reverts the alpha.24 release ([#453](https://github.com/scaleapi/scale-agentex/issues/453)) ([38ccd00](https://github.com/scaleapi/scale-agentex/commit/38ccd001059f2be32babcb07f201f83ed2e14bfd))
...
* **temporal:** use OTel settings for Core metrics ([#439](https://github.com/scaleapi/scale-agentex/issues/439)) ([0c171d0](https://github.com/scaleapi/scale-agentex/commit/0c171d0bebcb28b63c5bb18ea0b40d8e91841354))
