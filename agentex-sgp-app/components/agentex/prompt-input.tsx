...
export function PromptInput({ prompt, setPrompt }: PromptInputProps) {
  ...
  return (
    <div className="flex w-full flex-col gap-2">
      <div className="border-input dark:bg-input/30 disabled:bg-muted flex w-full items-center justify-between rounded-4xl border bg-transparent py-2 pr-2 pl-6 disabled:cursor-not-allowed">
        {isSendingJSON ? (
          <DataInput
            prompt={prompt}
            setPrompt={setPrompt}
