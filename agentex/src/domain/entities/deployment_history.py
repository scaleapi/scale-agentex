...
class DeploymentHistoryEntity(BaseModel):
    """
    Represents a deployment record in the system history.

    This entity tracks deployment information for agents, including
